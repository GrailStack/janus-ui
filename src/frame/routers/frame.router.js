...
import SystemManagementRouter from '../../system/routers/system-management.router'
import GatewayManagerRouter from "../../gateway-manage/routers/gateway-manage.router";
import MyGateMangeRouter from "../../my-gate/routers/my-gate.router"
import ChangesRouter from "../../changes/routers/changes.router"
import MonitorRouter from "../../monitor/routers/monitor.router"
...
_routerArray = _routerArray.concat(HomeModuleRouter.routers,
    DeskTopModuleRouter.routers,
    SystemManagementRouter.routers,
    GatewayManagerRouter.routers,
    MyGateMangeRouter.routers,
    ChangesRouter.routers,

    MonitorRouter.routers,
    ) // 首页
